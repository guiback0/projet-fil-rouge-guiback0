...
class UserController extends AbstractController
{
    ...
    /**
     * Formate les données d'accès et badgeuses
     */
    private function formatAccessData(User $user, ?array $currentService): array
    {
        $accesData = [];
        $badgeusesData = [];
        $uniqueBadgeuses = [];
        ...
        return [
            'zones' => $zonesData,
            'acces' => $accesData,
            'badgeuses' => $badgeusesData
        ];
    }

    /**
     * Formate les données utilisateur de base
     */
    ...
    /**
     * Formate les données des services
     */
    private function formatServicesData(User $user): array
    {
        $servicesData = [];
        $currentService = null;
    ...
    /**
     * Formate les données des badges
     */
    private function formatBadgesData(User $user): array
    {
        $badgesData = [];
