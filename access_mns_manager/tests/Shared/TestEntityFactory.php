...
class TestEntityFactory
{
    ...
    public static function createTestUser(EntityManagerInterface $em, UserPasswordHasherInterface $passwordHasher, string $email = 'test@example.com'): User
    {
    ...
    public static function createTestUserWithBadge(EntityManagerInterface $em, UserPasswordHasherInterface $passwordHasher, string $email = 'test@example.com'): array
    {
    ...
    public static function createTestUserWithBadgeuse(EntityManagerInterface $em, UserPasswordHasherInterface $passwordHasher, string $email = 'test@example.com'): array
    {
    ...
    public static function createCompleteTestSetup(EntityManagerInterface $em, UserPasswordHasherInterface $passwordHasher, string $email = 'test@example.com'): array
    {
        $organisation = self::createTestOrganisation();
        ...
        // Pas de DateFin pour que ce soit actif
        ...
        $user->addTravail($travaillerPrincipal);
        $user->addTravail($travaillerSecondaire);
